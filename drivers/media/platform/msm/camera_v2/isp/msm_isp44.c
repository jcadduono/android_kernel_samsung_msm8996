...
static int msm_vfe44_get_mmu_handles(struct vfe_device *vfe_dev)
{
	int rc = 0;
...
static void msm_vfe44_put_mmu_handles(struct vfe_device *vfe_dev)
{
...
struct msm_vfe_hardware_info vfe44_hw_info = {
	...
	.vfe_ops = {
		...
		.core_ops = {
			...
			.get_mmu_handles = msm_vfe44_get_mmu_handles,
			.put_mmu_handles = msm_vfe44_put_mmu_handles,
		},
		.stats_ops = {
